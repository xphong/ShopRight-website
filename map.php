...
<div id="main-content">
  ...
  <!--</head>-->
  <!--<body style="margin:50px; padding:0px;" onload="load()">--> 
    <div>
     <!--<input type="text" id="addressInput" size="10"/>-->
    <select id="radiusSelect">
      <option value="5" selected="true">5KM</option>
      <option value="10">10KM</option>
      <option value="20">20KM</option>
    </select>
    <input type="button" onclick="searchLocations()" value="Toronto Locations"/>
    </div>
